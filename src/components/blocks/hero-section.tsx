...
import { InfiniteSlider } from '@/components/ui/infinite-slider'; // Adjusted path
import { ProgressiveBlur } from '@/components/ui/progressive-blur'; // Adjusted path
        ...
        <>
            ...
            <main className="overflow-x-hidden">
                <section>
                    ...
                    <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                        <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                ...
                                <p className="mt-8 max-w-2xl text-pretty text-lg text-gray-700 dark:text-gray-300">Highly customizable components for building modern websites and applications that look and feel the way you mean it.</p>
                            ...
                            <img
                                ...
                                alt="Abstract Object"
                                height="4000" // Keep for aspect ratio hint if needed
                                width="3000"  // Keep for aspect ratio hint if needed
                            />
                        </div>
                    </div>
                </section>
                {/* Added dark mode background */}
                <section className="bg-gray-50 dark:bg-gray-800 pb-16 md:pb-32 text-gray-700 dark:text-gray-300">
                    <div className="group relative m-auto max-w-6xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            {/* Adjusted dark mode border */}
                            <div className="md:max-w-44 md:border-r md:border-gray-300 dark:md:border-gray-600 md:pr-6">
                            ...
                            <div className="relative py-6 md:w-[calc(100%-11rem)]">
                                ...
                                {/* ProgressiveBlur components */}
                                <ProgressiveBlur className="absolute inset-y-0 left-0 w-20" direction="left" />
                                <ProgressiveBlur className="absolute inset-y-0 right-0 w-20" direction="right" />
                            </div>
                        </div>
                    </div>
                </section>
...
const HeroHeader = () => {
    ...
    // Close menu on route change (optional, good UX for SPA)
    ...
    return (
        <header>
            <nav
                data-state={menuState ? 'active' : 'inactive'} // Use data-state for clarity
                className="group bg-background/80 fixed z-20 w-full border-b border-gray-200 dark:border-gray-700 backdrop-blur-lg"> {/* Adjusted background/blur */}
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full items-center justify-between gap-12 lg:w-auto">
                            ...
                            <button
                                ...
                                <Menu className="group-data-[state=active]:rotate-180 group-data-[state=active]:scale-0 group-data-[state=active]:opacity-0 m-auto size-6 transition-transform duration-200" />
                                <X className="group-data-[state=active]:rotate-0 group-data-[state=active]:scale-100 group-data-[state=active]:opacity-100 absolute inset-0 m-auto size-6 -rotate-180 scale-0 opacity-0 transition-transform duration-200" />
                            </button>
                            ...
                            <div className="hidden lg:block">
                                <ul className="flex gap-8 text-sm">
                                    {menuItems.map((item, index) => (
                                        <li key={index}>
                                            <Link
                                                to={item.href} // Use React Router Link
                        ...
                        {/* Mobile Menu & Desktop Buttons Container */}
                        <div className={cn(
                            "lg:flex lg:w-fit lg:items-center lg:gap-6", // Base styles for desktop buttons
                            "group-data-[state=active]:block", // Show on mobile when active
                            "group-data-[state=inactive]:hidden lg:group-data-[state=inactive]:flex", // Hide on mobile when inactive, show on desktop always
                            "absolute lg:relative top-full lg:top-auto left-0 lg:left-auto", // Positioning for mobile dropdown
                            "mt-2 lg:mt-0 p-6 lg:p-0 w-full lg:w-auto", // Padding and width
                            "bg-background lg:bg-transparent border lg:border-none rounded-lg lg:rounded-none shadow-lg lg:shadow-none", // Background, border, shadow
                            "flex flex-col lg:flex-row lg:flex-nowrap space-y-6 lg:space-y-0" // Flex layout
                        )}>
                            {/* Mobile Menu Items */}
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 lg:w-fit pt-6 lg:pt-0 border-t lg:border-none border-gray-200 dark:border-gray-700">
                                <Button
                                    asChild
                                    variant="outline"
                                    size="sm">
